<template>
    <div class="main">
        <div class="container">
            ...
            <ul>
                ...
                <li>-Предварительная оценка<br>
                    <span>стоимости разработки</span>
                </li>
                <li>-Проектирование прототипа</li>
                <li>-Составление технического<br>
                    <span>задания</span>
                </li>
                <li>-Разработка первого релиза<br>
                    <span>продукта</span>
                </li>
                <li>-Тестирование</li>
                <li>-Публикация</li>
        ...
        <img src="../assets/mobail/ifon-six.png" alt="pic" class="ifon">
