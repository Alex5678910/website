<template>
    <div class="container">
        ...
        <img src="../assets/mobail/x7.png" alt="">
...
<style scoped>
    ...
    .container {
        ...
        background-image: url(../assets/mobail/mbg.png);
